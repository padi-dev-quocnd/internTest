...
export default function Alert() {
  ...
  return (
    <div className='w-[268px] h-[133px] bg-[#F2F2F2] absolute top-[50%] left-[50%] -translate-x-2/4 -translate-y-2/4  rounded-[14px]'>
        <h2 className='px-[16px] py-[16px] text-[17px] fnt-hansanB text-center'>位置情報の取得を 許可しますか？</h2>
